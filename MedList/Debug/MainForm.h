		...
		void InitializeComponent(void)
		{
			...
			this->ôàéëToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(6) {
				this->ñîçäàòüToolStripMenuItem,
					this->îòêğûòüToolStripMenuItem, this->çàêğûòüToolStripMenuItem, this->ñîõğàíèòüToolStripMenuItem, this->íàéòèToolStripMenuItem,
					this->çàêğûòüÔàéëToolStripMenuItem
			});
			...
			this->ñîçäàòüToolStripMenuItem->Size = System::Drawing::Size(199, 22);
			...
			this->îòêğûòüToolStripMenuItem->Size = System::Drawing::Size(199, 22);
			this->îòêğûòüToolStripMenuItem->Text = L"Êîğğåêòèğîâêà çàïèñè";
			// 
			// çàêğûòüToolStripMenuItem
			// 
			this->çàêğûòüToolStripMenuItem->Name = L"çàêğûòüToolStripMenuItem";
			this->çàêğûòüToolStripMenuItem->Size = System::Drawing::Size(199, 22);
			this->çàêğûòüToolStripMenuItem->Text = L"Óäàëåíèå çàïèñè";
			// 
			// ñîõğàíèòüToolStripMenuItem
			// 
			this->ñîõğàíèòüToolStripMenuItem->Name = L"ñîõğàíèòüToolStripMenuItem";
			this->ñîõğàíèòüToolStripMenuItem->Size = System::Drawing::Size(199, 22);
			...
			this->íàéòèToolStripMenuItem->Size = System::Drawing::Size(199, 22);
			...
			this->çàêğûòüÔàéëToolStripMenuItem->Size = System::Drawing::Size(199, 22);
			...
			this->Main_panel->Controls->Add(this->linkLabel1);
			...
			this->linkLabel1->Location = System::Drawing::Point(592, 0);
			this->linkLabel1->Name = L"linkLabel1";
			this->linkLabel1->Size = System::Drawing::Size(50, 13);
			this->linkLabel1->TabIndex = 11;
			this->linkLabel1->TabStop = true;
			this->linkLabel1->Text = L"Ïîìîùü";
			// 
			// label7
			// 
	...
	MessageBox::Show("Ôàéë íå íàéäåí");
		...
		MessageBox::Show("Ñïèñîê ïóñò!");
		 ...
		 private: void NoStrInFile()
		 {
			 ...
			 çàêğûòüToolStripMenuItem->Enabled = false;
			 îòêğûòüToolStripMenuItem->Enabled = false;
				  ...
				  private: void YesStrInFile()
				  {
					  ...
					  çàêğûòüToolStripMenuItem->Enabled = true;
