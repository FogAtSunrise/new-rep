...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBox2->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &EditForm::textBox2_KeyPress);
			// 
			// textBox1
			// 
			...
			this->textBox1->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &EditForm::textBox1_KeyPress);
			// 
			// label12
			// 
			...
			this->textBoxzena->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &EditForm::textBoxzena_KeyPress);
			// 
			// textBoxnumber
			// 
			...
			this->textBoxnumber->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &EditForm::textBoxnumber_KeyPress);
			// 
			// textBoxdate
			// 
			...
			this->textBoxdate->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &EditForm::textBoxdate_KeyPress_1);
			// 
			// textBoxcountre
			// 
			...
			this->linkLabel1->Location = System::Drawing::Point(567, 6);
			this->linkLabel1->Name = L"linkLabel1";
			this->linkLabel1->Size = System::Drawing::Size(50, 13);
			this->linkLabel1->TabIndex = 121;
			this->linkLabel1->TabStop = true;
			this->linkLabel1->Text = L"Помощь";
			this->linkLabel1->LinkClicked += gcnew System::Windows::Forms::LinkLabelLinkClickedEventHandler(this, &EditForm::linkLabel1_LinkClicked);
			// 
			// EditForm
			// 
...
private: System::Void textBoxdate_KeyPress_1(System::Object^  sender, System::Windows::Forms::KeyPressEventArgs^  e) {
	if ((!(e->KeyChar > 47) || !(e->KeyChar < 58)) && (!(e->KeyChar == 8))) //запрет на ввод кроме цифр, запятой и bsp
	{
		e->Handled = true;
	}
...
private: System::Void linkLabel1_LinkClicked(System::Object^  sender, System::Windows::Forms::LinkLabelLinkClickedEventArgs^  e) {
	MessageBox::Show("Вы находитесь в меню редактора записи.\nНиже приведена последовательность действий изменения записи.\n\n-в текстовом окне введите ID записи, которую хоте ли бы изменитью \n-в правой части окна запись, разбитая на поля\n-измените необходимое поле и нажмите -Сохранить\nДля выхода достаточно просто закрыть окно");
}
};
}
